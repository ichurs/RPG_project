...
public class Goblin extends Creature implements Attackeable{
    String name;
    int health;
    int strength;
    int agility;
    ...
    int experience;
    int gold;
    String[] title = {"Soldier", "Fighter", "Chief", "Brawler", "Assassin", "Thug", "Manslayer",
                    "Scoundrel", "Blackguard", "Reprobate", "Bandit", "Gladiator"};

    public Goblin() {
        this.name = "Goblin " + title[(int)Math.floor(Math.random() * title.length)];
